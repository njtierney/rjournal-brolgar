...
```{r facet-year-along, echo = TRUE, fig.cap = "heights over time with facet strata along year"}
ggplot(heights_brolgar,
       aes(x = year,
           y = height_cm,
           group = country)) + 
...
XXX Say something about the paper build, and paper source files
