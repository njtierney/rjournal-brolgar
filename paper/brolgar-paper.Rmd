...
We can also look at the nearest 3 countries to each statistics, by changing `top_n = 5`:
...
Figure \@ref(fig:heights-keys-near-fancy-label) shows 

```{r heights-keys-near-fancy-label, fig.height = 12, fig.cap = "Figure of stereotypes for three"}
